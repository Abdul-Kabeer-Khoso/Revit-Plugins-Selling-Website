...
const DashboardSideBar = ({ setActiveDashboard, activeDashboard }) => {
  ...
  return (
    <div className="w-[25%] h-full flex flex-col justify-between items-center bg-white shadow-2xl rounded-lg p-4 ">
      ...
      <div className="w-full">
        <div
          className="w-full h-auto p-2 bg-red-400 text-red font-bold rounded-lg mb-4 flex justify-center items-center border border-2-red hover:cursor-pointer"
